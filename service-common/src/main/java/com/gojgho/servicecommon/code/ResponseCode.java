package com.gojgho.servicecommon.code;
...
public enum ResponseCode {
  ...
  IO_FAILED_ERROR("9016", "데이터를 읽어오는데 실패했습니다."),
  FILE_UPLOAD_FAILED_ERROR("9017", "파일 업로드에 실패했습니다."),
  DATA_IS_NULL("9018", "데이터가 존재하지 않습니다."),
  DATA_FORMAT_INVALID("9019", "데이터 타입이 올바르지 않습니다."),
  LIMIT_OVER_DATA_COUNT("9020", "데이터 갯수가 제한된 갯수를 초과했습니다."),
